...
public class managerTimesheetPage {
    ...
    private By timesheetsApprovalTab = By.xpath("//h3[@data-target='data-target='timesheet-approval/Timesheet_Approval__c/00B1K00000AN3gwUAD']");
    ...
    public String getTimesheetApprovalLink() throws InterruptedException {
        ...
        driver.findElement(timesheetApprovalLink).click(); // open the record
        Thread.sleep(2000);
        return recordName;
    }
